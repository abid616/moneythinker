            ...
            <a>
                <div className="object-cover card border-2 md:p-4 md:rounded h-full">
                    ...
                    <div className="card-body m-auto p-0 sm:p-2 w-full">
                        <h2 className="text-sm text-left sm:text-lg card-title h-5 sm:h-20 whitespace-nowrap sm:whitespace-normal text-ellipsis overflow-hidden text-center sm:text-left mb-1 sm:mb-2">{article.title}</h2>
