...
export const SlideItem = ({article, num}) => {
    return (
        <div className="p-4 bg-purple-500 rounded-lg">
            <div>
                <Images image={article.image} width={800} height={400} className="rounded-lg trending-image"/>
            </div>
            <p className="font-sans text-white text-xl md:mt-12 sm:mt-6 h-28 sm:h-8 overflow-hidden">{article.description}</p>
